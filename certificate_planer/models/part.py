...
class Part(models.Model):
    ...
    certificate_id = fields.Many2one(
        "certificate_planer.certificate", store=False, compute="_compute_get_certificate_id"
    )
    ...
    parent_bom_ids = fields.Many2many(
        "certificate_planer.bom",
    ...
    prequisite_bom_ids = fields.Many2many(
        "certificate_planer.bom",
    ...
    is_ems_equipment = fields.Boolean("Installation Group", default=False)
