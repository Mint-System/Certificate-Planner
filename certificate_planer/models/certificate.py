...
class Certificate(models.Model):
    ...
    aircraft_type_id = fields.Many2one(
        "certificate_planer.aircraft_type", required=True, string="Aircraft Type", tracking=True, ondelete="restrict"
    )
    specification_id = fields.Many2one(
        "certificate_planer.specification", required=True, string="Specification", tracking=True, ondelete="restrict"
    )
