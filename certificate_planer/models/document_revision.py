...
class DocumentRevision(models.Model):
    ...
    document_id = fields.Many2one(
        "certificate_planer.document", string="Document", required=True, tracking=True, ondelete="restrict"
    )
    index_id = fields.Many2one(
        "certificate_planer.document_revision_index", required=True, string="Index", tracking=True, ondelete="restrict"
    )
