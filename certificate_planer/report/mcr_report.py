        ...
        for survey_input in survey_result.survey_id.question_and_page_ids:
            ...
            if not survey_input.is_page:
                ...
                if survey_input.question_type in ["simple_choice", "multiple_choice"]:
                    entry["options"] = [
                        {"id": suggestion.id, "value": suggestion.value}
                        for suggestion in survey_input.suggested_answer_ids
                    ]
                ...
                suggested_answers = answers.filtered(lambda a: a.answer_type == "suggestion").mapped(
                    "suggested_answer_id"
                )
